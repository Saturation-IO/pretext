...
/** Inject a custom canvas 2D context (e.g. node-canvas for server-side use). */
export declare function setMeasureContext(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D): void;
